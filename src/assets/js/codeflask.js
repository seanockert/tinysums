...
CodeFlask.prototype.runAll = function(selector, opts) {
  ...
  var textAreas = document.getElementsByClassName("cf-textarea");
...
CodeFlask.prototype.scaffold = function(target, isMultiple, opts) {
  ...
  target.classList.add('cf');
  textarea.classList.add('cf-textarea');
  textarea.setAttribute('id', 'cf-textarea');
  container.classList.add('cf-container');
  output.classList.add('output');
  output.setAttribute('id', 'output');
  highlightPre.classList.add('cf-pre');
  highlightCode.classList.add('cf-code');
